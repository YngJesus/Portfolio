      ...
      <div className="container mx-auto max-w-6xl relative z-10">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          {Object.entries(skills).map(([category, skillList], idx) => (
            <Card
              key={category}
              className="p-8 bg-card/50 backdrop-blur-sm border-primary/20 hover:border-primary/40 transition-all duration-500 fade-in-item hover-lift group relative overflow-hidden"
